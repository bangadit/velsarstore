  ...
  <body>
    <div id="content" class="col-sm-9">
      <div class="row">
        ...
        $ambil = $koneksi->query("SELECT * FROM produk where kategori='Bibit'"); ?>
            ...
            <div class="col-md-4 text-center col-sm-6 col-xs-6">
                <div class="thumbnail product-box">
                    ...
                    <div class="caption">
                        ...
                        if ($data['stok'] > 0) {
                        ?>
                        <p><a href="model/p_beli.php?id=<?php echo $data['id']; ?>" class="btn btn-success" role="button">Beli Sekarang</a>
                        <?php } ?>
                        <br>
                        <?php
