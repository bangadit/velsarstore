            ...
            <div class="col-sm-12">
              <div class="searchtop pull-right">
                <ul class="nav nav-pills">
                  <li><a href="shop?page=keranjang#belanja">
                    CART
                  </a></li>
                  <?php
                  ...
                  <li>
                    <form class="searchform" action="?page=cari#belanja" method="post" role="search">
